    ...
    >
      <div className={cn("min-h-11 shrink-0", fullScreen && "hidden")}>
        <button
          ref={panelToggleRef}
          type="button"
          aria-expanded={fullScreen ? undefined : expanded}
          aria-controls="conversation-computer-pane"
          onClick={fullScreen ? undefined : () => onExpandedChange(!expanded)}
      ...
      <div
        ...
        className={cn(
          ...
          fullScreen ? "min-h-0 flex-1 transition-none" : expanded ? "max-h-[200px]" : "max-h-0",
        )}
      >
        {expanded ? (
          <div
