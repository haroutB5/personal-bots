...
import { CircleCheck, File, Laptop, MessageCircle, type LucideIcon } from "lucide-react";
 ...
 * four equal columns with a 24px outline icon over a 12px label. The active
