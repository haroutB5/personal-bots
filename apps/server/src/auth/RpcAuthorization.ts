...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.personalBotsList]: AuthOrchestrationReadScope,
  [WS_METHODS.personalBotsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.personalBotsUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.personalBotsDelete]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.personalConnectionsDisable]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.personalConnectionsBrowserConnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.personalConnectionsSetSettings]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.personalLoginsList]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.personalBrowserReturnToAgent]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.personalMemoryDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.personalPushPublicKey]: AuthOrchestrationReadScope,
  [WS_METHODS.personalPushGetSettings]: AuthOrchestrationReadScope,
  [WS_METHODS.personalPushSubscribe]: AuthOrchestrationOperateScope,
  [WS_METHODS.personalPushUnsubscribe]: AuthOrchestrationOperateScope,
  [WS_METHODS.personalPushTest]: AuthOrchestrationOperateScope,
