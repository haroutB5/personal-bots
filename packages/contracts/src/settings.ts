...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Decision rich-text-composer-default: upstream turns rich text on for
  // everyone. We keep the literal-Markdown composer as the default and leave
  // rich text as an opt-in from Settings, so typing and pasting on the phone
  // do not change under us.
